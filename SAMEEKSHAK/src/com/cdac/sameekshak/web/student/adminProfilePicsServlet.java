...
public class adminProfilePicsServlet  extends HttpServlet {
	...
	public void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException{
		...
		try {
			...
			AdminManager umr = (AdminManager) ref;
			Administrator admin= (Administrator)request.getAttribute("adminPic");
			byte[] image=umr.showAdminImage(admin.getAdminId());
